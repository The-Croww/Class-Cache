...
use App\Filament\Resources\FinesResource\Pages;
use App\Filament\Resources\FinesResource\RelationManagers;
...
class FinesResource extends Resource
{
    protected static ?string $model = Fines::class;
    ...
    public static function getPages(): array
    {
        return [
            ...
            'create' => Pages\CreateFines::route('/create'),
            'edit' => Pages\EditFines::route('/{record}/edit'),
        ];
    }
}
